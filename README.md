...
The goal of this porject is to take  compare and contrast the Apollo guidance computer original assmebly code to the Cornell Project that mapped that code to a Raspberry Pi using Python
